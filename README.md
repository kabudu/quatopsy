...
The viewer includes a searchable, paginated finding queue, canonical evidence inspector, exact timestamp identities, source context, named candidate comparison, component traces, and time/index navigation. Downsampled geometry distinguishes exact finding endpoints from approximate links.
