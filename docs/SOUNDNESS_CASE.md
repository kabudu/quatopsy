...
| Declared plant models | Optional lag, magnetic residual, gravity-gradient, gyro ARW, star-tracker delay | Independent oracles; must not be presented as hardware |
