...
| BRAND-1 | Ship versioned canonical brand sources, exports, tokens, and overlay-separated templates | Brand | `scripts/brandkit.py check` | `quatopsy.brand/2` local CI and visual QA log | verified |
